#!/usr/bin/env python3
"""
Merge Tier 1, Tier 2 (web research), and Falcon Lake deep research into cases-v5-master.json
"""
...
RESEARCH_DATA = {
    "CAN-012": {  # FALCON LAKE - Deep Tier 3 Research
        ...
        "related_cases": ["CAN-009"],  # Yellowknife - also radioactive evidence
...
def assign_tier(c):
    ...
    famous_ids = ["CAN-012", "CAN-013", "CAN-044", "CAN-046", "CAN-028", "CAN-018",
                  "CAN-009", "CAN-030", "CAN-043", "CAN-055", "CAN-011"]
