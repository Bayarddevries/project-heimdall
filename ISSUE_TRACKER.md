...
| H-017 | Dymo label UI elements | P2 | Open | Add Dymo label maker style for case numbers, dates, classification headers |
| H-018 | Brass prong / punch binding | P2 | Open | Add two-hole punch + brass fastener graphics to inner document pages |
| H-019 | Post-it note buttons | P1 | Open | Replace HTML buttons with Post-it note style (yellow #FEFF9C with rough edges) |
| H-020 | CONFIDENTIAL rubber stamp | P1 | Open | Red stamp graphic with hover effect (depresses/darkens on click) |
| H-021 | Hand-drawn checkboxes | P2 | Open | X marks in hand-drawn squares for filter toggles |
| H-022 | Paperclip toggle switches | P2 | Open | Metal paperclip slides between positions as toggle UI element |
...
| ID | Title | Priority | Status | Description |
|----|-------|----------|--------|-------------|
| H-050 | NUFORC data cross-reference | P1 | Open | Mine NUFORC for additional Canadian reports to expand dataset beyond 54 |
...
| H-060 | Geolocation verification | P1 | Open | Verify lat/lng for all 54 cases with modern mapping tools |
